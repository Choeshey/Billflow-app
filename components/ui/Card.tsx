...
export function Card({ children, noPad = false, className, ...rest }: CardProps) {
  return (
...
function Header({ className, children, ...rest }: SectionProps) {
  return <div className={cn("px-5 py-4 border-b border-slate-100", className)} {...rest}>{children}</div>;
}
function Body({ className, children, ...rest }: SectionProps) {
  return <div className={cn("px-5 py-4", className)} {...rest}>{children}</div>;
}
function Footer({ className, children, ...rest }: SectionProps) {
